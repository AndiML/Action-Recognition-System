...
from mediapipe.python.solutions.holistic import HolisticResults
...
class HolisticPoseProcessor:
    ...
    def extract_face_keypoints(self, results: HolisticResults) -> numpy.ndarray:
        """
    ...
    def extract_left_hand_keypoints(self, results: HolisticResults) -> numpy.ndarray:
        """
    ...
    def extract_right_hand_keypoints(self, results: HolisticResults) -> numpy.ndarray:
        """
    ...
    def extract_pose_keypoints(self, results: HolisticResults) -> numpy.ndarray:
        """
    ...
    def extract_all_keypoints(self, results: HolisticResults) -> numpy.ndarray:
        """
